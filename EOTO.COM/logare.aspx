<%@ Page Language="C#" AutoEventWireup="true" CodeFile="logare.aspx.cs" Inherits="logare" %>
...
<form id="Form1" runat="server">
            ...
            <div class="right menu">
                ...
                <div class="item" id="DesktopFormSignin" runat="server">
                    <div class="ui buttons">
                        <a href="logare.aspx" class="ui active teal button"><i class="signing icon"></i>Logare</a>
    ...
    <div id="animate-area" style="position: relative">
        ...
        <h2 class="ui icon header" style="color:white">
            ...
            <div class="content">Logare<div class="sub header" style="color:white">Proces de identificare personală a unui utilizator sau navigator care intenţionează să se conecteze la un serviciu ordine de pe Internet. Aceasta consta, mai exact, în introducerea cu ajutorul unei tastaturi a unui nume de utilizator şi a unei parole unice în momentul solicitării acestora.</div></div>
        </h2>
        </div>
    ...
    <div class="ui container" style="padding-top:50px;padding-bottom:50px">
        ...
        <div id="mesaj_cont_gresit" runat="server" class="ui negative icon message" style="margin-bottom:20px;">
            <i class="close icon"></i>
            <i class="delete icon"></i>
            <div class="content">
                <div class="header">Nume de utilizator si/sau parola incorecta!</div>
                <p>Datele introduse nu apar in baza de date. Va rugam sa incercati alte date!</p>
            </div>
        </div>
        ...
        <div class="ui two column centered stackable grid">
            <div class="column">
                <div class="ui attached icon message">
                    <i class="user circle icon"></i>
                    <div class="content">
                        <div class="header">Aveti deja un cont inregistrat?</div>
                        <p>Logati-va pentru a avea acces la toate facilitatile site-ului.</p>
                    </div>
                </div>
                    ...
                    <div class="ui form">
                        <div class="field">
                            ...
                            <div class="ui left icon input">
                              <input id="utilizator" runat="server" type="text" placeholder="Utilizator"/>
                              <i class="user icon"></i>
                            </div>
                        </div>
                        <div class="field">
                            <label>Parola</label>
                            <div class="ui left icon input">
                              <input id="parola" runat="server" type="password" placeholder="Parola"/>
                              <i class="lock icon"></i>
                            </div>
                        </div>
                        <a id="A2" runat="server" onserverclick="Login_Click" class="ui fluid blue button">Logare</a>
